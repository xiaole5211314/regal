...
const STREAM_LINES: Array<{ speaker: Speaker; text: string }> = [
    ...
    { speaker: "LAWYER 1", text: "Before we proceed¡ªdid you discuss meeting at a restaurant near the courthouse?" },
    ...
    { speaker: "WITNESS", text: "A small diner¡ªno, I don't remember the name." },
    ...
    function buildExportText() {
        return formatLegalTranscript({
            logs,
            profile,
            caseTitle: "REGAL ¡ª LEGAL OPERATIONS PLATFORM",
    ...
    const styles: Record<string, any> = {
        ...
        // Right transcript: NO inner scroll ¡ª page scrolls
      ...
      `}</style>
                    ...
                    <div style={styles.verifyModal}>
                        <div style={styles.verifyTop}>
                            <div>
                                ...
                                <div style={{ fontSize: 12, color: c.muted, marginTop: 6 }}>Demo mode ¡ª prefilled for fast presentation.</div>
                            </div>
            ...
            <div style={styles.container}>
                ...
                <div style={styles.grid}>
                    {/* Left ¡ª sticky so you can always pause/stop */}
                    ...
                    {/* Right ¡ª transcript (page scrolls) */}
                                    ...
                                    return (
                                        <div key={m.id} style={{ margin: "10px 0" }} ref={setMsgRef(m.id)}>
                                            <div style={styles.markLine}>
                                                ¡ª {m.text} ¡ª <span style={{ opacity: 0.75, marginLeft: 10 }}>{fmtTime(m.at)}</span>
                                            </div>
                                        </div>
                                    );
                                }
